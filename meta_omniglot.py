...
from load_omniglot_set import load_omniglot
...
def main(lr=0.005, maml_lr=0.01, iterations=1000, ways=1, shots=16, tps=32, fas=5, device=torch.device("cpu"),
    ...
    train_tasks, test_tasks = load_omniglot(ways, shots)
    ...
    for iteration in range(iterations):
        ...
        for t in range(tps):
            ...
            print(adaptation_data.shape, evaluation_data.shape, adaptation_data.min(), adaptation_data.max())
...
if __name__ == '__main__':
    ...
    parser.add_argument('--download-location', type=str, default="/tmp/omniglot", metavar='S',
                        help='download location for train data (default : /tmp/omniglot')
